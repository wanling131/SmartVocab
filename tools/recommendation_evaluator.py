...
class RecommendationEvaluator:
    ...
    def evaluate_novelty(self, recommendations: List[Dict],
    ...
    def evaluate_personalization(self, user_id: int,
        ...
        avg_rec_difficulty = sum(rec_difficulties) / len(rec_difficulties) if rec_difficulties else 3
    ...
    def full_evaluation(self, user_id: int,
    ...
    def compare_algorithms(self, user_id: int,
